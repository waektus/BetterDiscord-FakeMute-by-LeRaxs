...
module.exports = class FakeMuteByLeRaxs {
    constructor() {
        ...
        this.settings = {
            accountButton: true,
            domFallback: true,
            useAlt: true, // ใช้ Alt+C เป็น shortcut เช่น useCtrl: false, useAlt: true
            useCtrl: false // ใช้ Ctrl+C เป็น shortcut เช่น useCtrl: true, useAlt: false 
            // หรืออาจจะเพิ่มทั้งสองก็ได้ เช่น useCtrl: true, useAlt: true (จะใช้ได้ทั้ง Alt+C และ Ctrl+C)
        };
    ...
    _onKeyDown(e) {
        ...
        const isAltShortcut =
            this.settings.useAlt &&
            e.altKey &&
            !e.ctrlKey &&
            !e.shiftKey &&
            !e.metaKey &&
            e.code === 'KeyC'; // Alt+C สามารถเปลี่ยนเป็นปุ่มอื่นได้ เช่น e.code === 'KeyD' สำหรับ Alt+D

        const isCtrlShortcut =
            this.settings.useCtrl &&
            e.ctrlKey &&
            !e.altKey &&
            !e.shiftKey &&
            !e.metaKey &&
            e.code === 'KeyC'; // Ctrl+C สามารถเปลี่ยนเป็นปุ่มอื่นได้ เช่น e.code === 'KeyD' สำหรับ Ctrl+D
